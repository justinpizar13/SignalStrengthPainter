...
| **`PaywallView.swift`** | NetSpot-inspired Pro upsell screen: Canvas hero, pricing cards (**Monthly $2.99**, **Yearly ~~$19.99~~ $9.99** with "Best Deal" badge), Buy Now CTA, Restore / Not Now links, X close. Now accepts optional `onPurchase` closure for tab-mode integration. StoreKit not yet wired. |
...
- **Pricing:** Monthly **$2.99**, Yearly **$9.99** (shown with ~~$19.99~~ strikethrough + red "Best Deal" badge).
