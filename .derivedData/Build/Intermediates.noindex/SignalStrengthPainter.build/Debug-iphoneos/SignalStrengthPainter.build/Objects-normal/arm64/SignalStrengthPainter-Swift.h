...
#ifndef SIGNALSTRENGTHPAINTER_SWIFT_H
#define SIGNALSTRENGTHPAINTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SignalStrengthPainter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21SignalStrengthPainter17ARTrackingManager")
...
@class ARFrame;
@class ARCamera;
@interface ARTrackingManager (SWIFT_EXTENSION(SignalStrengthPainter)) <ARSessionDelegate>
